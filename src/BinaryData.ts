...
*/
export function getStringBufferByteLength( value: string,
...
*/
export function getString( data: DataView | ArrayBufferLike,
...
*/
export function setStringBuffer( data: DataView | ArrayBufferLike, value: string,
	encoding: 'base16' | 'base41' | 'ascii' | 'ucs2' = 'ucs2', littleEndian?: boolean ): ArrayBuffer {
	if ( data.byteLength < getStringBufferByteLength( value, encoding ) ) {
...
*/
export function getBigInt( data: DataView | ArrayBufferLike ): bigint {
	const dv = data instanceof DataView ? data : new DataView( data );
	let v = 0n;
	for ( let i = 0; i < dv.byteLength; ++i ) {
...
/**
	...
	@returns encoded buffer
*/
export function setBigIntBuffer( data: DataView | ArrayBufferLike, value: bigint ): ArrayBuffer {
	const dv = data instanceof DataView ? data : new DataView( data );
	let v = value;
	for ( let i = 0; i < dv.byteLength; ++i ) {
