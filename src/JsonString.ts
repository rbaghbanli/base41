...
/**
	...
	@returns JSON string
*/
export function getString<T = any>( value: T, space?: number | string ): string {
	return JSON.stringify( value, _replace, space );
}
...
*/
export function getObject<T = any>( value: string ): T {
	return JSON.parse( value, _revive ) as T;
}
